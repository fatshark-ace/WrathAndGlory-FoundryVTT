...
export async function preparePsychicRoll(rollData: RollData) {
...
export async function prepareWeaponRoll(rollData: RollData) {
...
export async function prepareDamageRoll(rollData: RollData) {
...
function _getTargetDefense(combat: void) {
...
function getRank(rollData: RollData, rank: string): number {
  switch (rank) {
    case "none":
      return 0;
    case "single":
